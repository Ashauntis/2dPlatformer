...
export default class OverworldMap extends Phaser.Scene {
  constructor() {
    ...
    this.locations.push(new MapPoint('1,0',   73,   26, null, '2,0', '1,1', null));
    ...
    this.locations.push(new MapPoint('1,2',   72,   92, null, '2,2', '1,3', null));
    this.locations.push(new MapPoint('2,2',   104,  92, null, '3,2', null, '1,2'));
    this.locations.push(new MapPoint('3,2',   136,  92, '3,1', null, null, '2,2'));
    this.locations.push(new MapPoint('1,3',   72,   126, '1,2', null, '1,4', null));
    this.locations.push(new MapPoint('2,3',   104,  126, null, '3,3', null, null));
    this.locations.push(new MapPoint('3,3',   136,  126, null, '4,3', '3,4', '2,3'));
    this.locations.push(new MapPoint('4,3',   168,  126, null, '5,3', null, '3,3'));
    this.locations.push(new MapPoint('5,3',   200,  126, null, null, null, '4,3'));
    this.locations.push(new MapPoint('1,4',   72,   160, '1,3', '2,4', null, null));
    this.locations.push(new MapPoint('2,4',   104,  160, null, '3,4', null, '1,4'));
    this.locations.push(new MapPoint('3,4',   136,  160, '3,3', null, null, '2,4'));
  }
  ...
  update (time, delta) {
    ...
    if(this.move_start === 0) {
      ...
      if(this.current_location !== this.current_point.name) {
        ...
        this.physics.moveTo(this.mario, this.current_point.x, this.current_point.y, 1, this.move_time);
        this.move_start = time;
      }
    } else {
      let stop = false;

      if(this.mario.x === this.current_point.x && this.mario.y === this.current_point.y) stop = true;
      if(this.move_start + this.move_time < time) stop = true;
